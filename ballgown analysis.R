...
results_transcripts$JGI <- mart_export$GeneID[match(transcripts_6h$transcriptNames,mart_export$transcriptNames)]

write.csv(results_transcripts,"results_transcripts.csv",row.names=FALSE)
